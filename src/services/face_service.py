...
from src.schemas.models import FaceInfo, FaceRecognitionResponse, InfoResponse, ClusterInfo, CorrectFaceAssignmentResponse, XmpFace
    ...
    for person_dir in dataset_path.iterdir():
        ...
        if person_embeddings:
            ...
            for i, embedding in enumerate(person_embeddings):
                cluster_id, _, _, _, _, _, _ = vector_store.add_face_embedding(
